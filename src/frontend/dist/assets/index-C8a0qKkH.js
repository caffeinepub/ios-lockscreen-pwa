...
function SettingsPanel({
  ...
  const flashIconRef = reactExports.useRef(null);
  const cameraIconRef = reactExports.useRef(null);
  ...
  const handleFlashIconChange = reactExports.useCallback(
    (e) => {
      var _a2;
      const file = (_a2 = e.target.files) == null ? void 0 : _a2[0];
      if (!file) return;
      const url = URL.createObjectURL(file);
      onUpdate({ flashlightCustomIcon: url });
    },
    [onUpdate]
  );
  const handleCameraIconChange = reactExports.useCallback(
    (e) => {
      var _a2;
      const file = (_a2 = e.target.files) == null ? void 0 : _a2[0];
      if (!file) return;
      const url = URL.createObjectURL(file);
      onUpdate({ cameraCustomIcon: url });
    },
    [onUpdate]
  );
  const rowStyle = {
      ...
      children: options.map((o) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          style: {
            ...
            background: value === o.value ? "rgba(255,255,255,0.85)" : "transparent",
  ...
  const Toggle = ({
    ...
    "button",
    {
      ...
      style: {
        ...
        borderRadius: 14,
        border: "none",
        background: checked ? "rgba(48,209,88,1)" : "rgba(255,255,255,0.2)",
        cursor: "pointer",
        position: "relative",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "settings-scroll", style: { flex: 1, paddingTop: 4 }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: rowStyle, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: labelStyle, children: "Edit Layout" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: subLabelStyle, children: "Drag elements to reposition" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: labelStyle, children: "Wallpaper" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: subLabelStyle, children: "Choose a custom lockscreen background" })
                      ] }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "button",
                        {
                ...
                settings.backgroundImage && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", gap: 8, alignItems: "center" }, children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      style: {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: labelStyle, children: "Flashlight Icon" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: subLabelStyle, children: "Show or hide the flashlight button" })
                      ] }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        Toggle,
                        {
                          checked: settings.flashlightVisible,
                          onChange: () => onUpdate({ flashlightVisible: !settings.flashlightVisible })
                        }
                      )
                    ]
                  }
                ),
                settings.flashlightVisible && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", gap: 8, alignItems: "center" }, children: [
                  settings.flashlightCustomIcon && /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      style: {
                        width: 40,
                        ...
                        borderRadius: "50%",
                        background: "rgba(255,255,255,0.15)",
                        backgroundImage: `url(${settings.flashlightCustomIcon})`,
                        backgroundSize: "70%",
                        backgroundPosition: "center",
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    ...
                    {
                      type: "button",
                      "data-ocid": "settings.flashlight.upload_button",
                      onClick: () => {
                        var _a2;
                        return (_a2 = flashIconRef.current) == null ? void 0 : _a2.click();
                      },
                      style: {
                        flex: 1,
                        padding: "8px 14px",
                      ...
                      children: settings.flashlightCustomIcon ? "Change Image" : "Upload Custom Icon"
                    }
                  ),
                  settings.flashlightCustomIcon && /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
                      type: "button",
                      "data-ocid": "settings.flashlight.delete_button",
                      onClick: () => onUpdate({ flashlightCustomIcon: null }),
                      style: {
                        padding: "8px 12px",
                ...
                settings.flashlightVisible && settings.flashlightCustomIcon && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    style: {
                      display: "flex",
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: subLabelStyle, children: "Resize mode" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        "select",
                        {
                          "data-ocid": "settings.flashlight.select",
                          value: settings.flashlightIconFit,
                          onChange: (e) => onUpdate({
                            flashlightIconFit: e.target.value
                          }),
                          style: {
                            background: "rgba(255,255,255,0.1)",
                          ...
                          children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "contain", style: { background: "#1a1a1a" }, children: "Fit (contain)" }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "cover", style: { background: "#1a1a1a" }, children: "Fill (cover)" }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "fill", style: { background: "#1a1a1a" }, children: "Stretch (fill)" })
                          ]
                        }
                      )
                    ]
                ...
                settings.flashlightVisible && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { paddingTop: 4 }, children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                      style: {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: subLabelStyle, children: "Button size" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsxs(
                          "div",
                          {
                            style: { ...subLabelStyle, color: "rgba(255,255,255,0.7)" },
                            children: [
                              settings.flashlightIconSize,
                              "px"
                            ]
                          }
                        )
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "input",
                    {
                      "data-ocid": "settings.flashlight.size_input",
                      type: "range",
                      min: 40,
                      max: 140,
                      value: settings.flashlightIconSize,
                      onChange: (e) => onUpdate({ flashlightIconSize: Number(e.target.value) }),
                      style: {
                        width: "100%",
                        accentColor: "white",
                        cursor: "pointer"
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "input",
                  {
                    ...
                    accept: "image/*",
                    style: { display: "none" },
                    onChange: handleFlashIconChange
                  }
                )
              ]
            }
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: labelStyle, children: "Camera Icon" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: subLabelStyle, children: "Show or hide the camera button" })
                      ] }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        Toggle,
                        {
                          checked: settings.cameraVisible,
                          onChange: () => onUpdate({ cameraVisible: !settings.cameraVisible })
                        }
                      )
                    ]
                  }
                ),
                settings.cameraVisible && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", gap: 8, alignItems: "center" }, children: [
                  settings.cameraCustomIcon && /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      style: {
                        width: 40,
                        ...
                        borderRadius: "50%",
                        background: "rgba(255,255,255,0.15)",
                        backgroundImage: `url(${settings.cameraCustomIcon})`,
                        backgroundSize: "70%",
                        backgroundPosition: "center",
                        backgroundRepeat: "no-repeat",
                        border: "1px solid rgba(255,255,255,0.2)",
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    ...
                    {
                      type: "button",
                      "data-ocid": "settings.camera.upload_button",
                      onClick: () => {
                        var _a2;
                        return (_a2 = cameraIconRef.current) == null ? void 0 : _a2.click();
                      },
                      style: {
                        flex: 1,
                        padding: "8px 14px",
                      ...
                      children: settings.cameraCustomIcon ? "Change Image" : "Upload Custom Icon"
                    }
                  ),
                  settings.cameraCustomIcon && /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
                      type: "button",
                      "data-ocid": "settings.camera.delete_button",
                      onClick: () => onUpdate({ cameraCustomIcon: null }),
                      style: {
                        padding: "8px 12px",
                        background: "rgba(255,60,60,0.18)",
                        border: "1px solid rgba(255,60,60,0.25)",
                ...
                settings.cameraVisible && settings.cameraCustomIcon && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    style: {
                      display: "flex",
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        "select",
                        {
                          "data-ocid": "settings.camera.select",
                          value: settings.cameraIconFit,
                          onChange: (e) => onUpdate({
                            cameraIconFit: e.target.value
                          }),
                          style: {
                            background: "rgba(255,255,255,0.1)",
                            border: "1px solid rgba(255,255,255,0.15)",
                ...
                settings.cameraVisible && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { paddingTop: 4 }, children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                      style: {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "input",
                    {
                      "data-ocid": "settings.camera.size_input",
                      type: "range",
                      min: 40,
                      max: 140,
                      value: settings.cameraIconSize,
                      onChange: (e) => onUpdate({ cameraIconSize: Number(e.target.value) }),
                      style: {
                        width: "100%",
                        accentColor: "white",
                        cursor: "pointer"
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "input",
                  {
                    ...
                    accept: "image/*",
                    style: { display: "none" },
                    onChange: handleCameraIconChange
                  }
                )
              ]
            }
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: rowStyle, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: labelStyle, children: "Pinch to Resize Icons" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: subLabelStyle, children: "Pinch icons to change their size" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Toggle,
              {
                checked: settings.pinchResizeEnabled,
                onChange: () => onUpdate({ pinchResizeEnabled: !settings.pinchResizeEnabled }),
                "data-ocid": "settings.pinch_resize.toggle"
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: rowStyle, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: labelStyle, children: "Display Mode" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { "data-ocid": "settings.toggle", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              Seg,
              {
                options: [
                  { label: "iOS", value: "ios" },
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: rowStyle, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: labelStyle, children: "Time Format" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Seg,
              {
                options: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: rowStyle, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: labelStyle, children: "Clock Font" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "select",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "sf", style: { background: "#1a1a1a" }, children: "SF Pro (iOS)" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "helvetica", style: { background: "#1a1a1a" }, children: "Helvetica" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "roboto", style: { background: "#1a1a1a" }, children: "Roboto" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "georgia", style: { background: "#1a1a1a" }, children: "Georgia" })
                ]
              }
            )
          ] }),
            ...
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", justifyContent: "space-between" }, children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: labelStyle, children: "Clock Size" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { ...labelStyle, opacity: 0.6 }, children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "input",
                  {
                    ...
                    onChange: (e) => onUpdate({ clockScale: Number.parseFloat(e.target.value) }),
                    style: { width: "100%" }
                  }
                )
              ]
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "button",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: labelStyle, children: "How It Works" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "rgba(255,255,255,0.4)", fontSize: 14 }, children: showTutorial ? "▲" : "▼" })
                    ]
                  }
                ),
                showTutorial && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    style: {
                      marginTop: 12,
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "p",
                        {
                          ...
                          children: "Hidden Grid Feature"
                        }
                      ),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { marginBottom: 8 }, children: "The screen is divided into an invisible 3×3 grid (9 zones). Each zone corresponds to 1–9 minutes." }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { style: { marginBottom: 8 }, children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { style: { color: "rgba(255,255,255,0.8)" }, children: "1st tap:" }),
                        " ",
                        "Select a zone (top-left = 1 min, bottom-right = 9 min). The clock immediately jumps forward by that many minutes + 40 seconds."
                      ] }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { style: { marginBottom: 8 }, children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { style: { color: "rgba(255,255,255,0.8)" }, children: "2nd tap:" }),
                        " ",
                        "Triggers rewind mode. The clock freezes for 3 seconds, then smoothly rewinds back to real time."
                      ] }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Perfect for casually glancing at a phone while establishing an alibi window. 😉" })
                    ]
                  }
                )
              ]
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { ...rowStyle, borderBottom: "none", paddingBottom: 0 }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: labelStyle, children: "Reset Clock State" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: subLabelStyle, children: "Return to real time immediately" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
...
function App() {
  const [displayHours, setDisplayHours] = reactExports.useState("");
  const [displayMins, setDisplayMins] = reactExports.useState("");
  const [displayDate, setDisplayDate] = reactExports.useState("");
  const [displayDay, setDisplayDay] = reactExports.useState("");
  const [showSettings, setShowSettings] = reactExports.useState(false);
  const [isEditMode, setIsEditMode] = reactExports.useState(false);
  const [positions, setPositions] = reactExports.useState(loadPositions);
  const [dragTarget, setDragTarget] = reactExports.useState(
    null
  );
  const [settings, setSettings] = reactExports.useState({
    ...
    cameraVisible: true,
    flashlightCustomIcon: null,
    cameraCustomIcon: null,
    flashlightIconFit: "contain",
    cameraIconFit: "contain",
    flashlightIconSize: 72,
    cameraIconSize: 72,
    pinchResizeEnabled: true
  });
  const realTimeRef = reactExports.useRef(/* @__PURE__ */ new Date());
  const offsetMinutesRef = reactExports.useRef(0);
  const isAdvancedRef = reactExports.useRef(false);
  const rewindDelayActiveRef = reactExports.useRef(false);
  const isRewindingRef = reactExports.useRef(false);
  const tapCountRef = reactExports.useRef(0);
  const rewindStartTimeRef = reactExports.useRef(0);
  const rewindDurationRef = reactExports.useRef(0);
  const rewindFromRef = reactExports.useRef(0);
  const lastSecondRef = reactExports.useRef(-1);
  const rafRef = reactExports.useRef(0);
  const settingsRef = reactExports.useRef(settings);
  const showSettingsRef = reactExports.useRef(false);
  const cameraTapTimeRef = reactExports.useRef(0);
  const isEditModeRef = reactExports.useRef(false);
  const dragTargetRef = reactExports.useRef(null);
  const dragStartPointerRef = reactExports.useRef({ x: 0, y: 0 });
  const dragStartPosRef = reactExports.useRef({ x: 0, y: 0 });
  const pendingRafRef = reactExports.useRef(null);
  const flashlightPointersRef = reactExports.useRef(
    /* @__PURE__ */ new Map()
  );
  const cameraPointersRef = reactExports.useRef(
    /* @__PURE__ */ new Map()
  );
  const flashlightPinchStartDistRef = reactExports.useRef(null);
  const flashlightPinchStartSizeRef = reactExports.useRef(72);
  const cameraPinchStartDistRef = reactExports.useRef(null);
  const cameraPinchStartSizeRef = reactExports.useRef(72);
  const [showFlashlightSizeHint, setShowFlashlightSizeHint] = reactExports.useState(false);
  const [showCameraSizeHint, setShowCameraSizeHint] = reactExports.useState(false);
  const flashlightHintTimerRef = reactExports.useRef(
    null
  );
  const cameraHintTimerRef = reactExports.useRef(null);
  reactExports.useEffect(() => {
  ...
  const updateSettings = reactExports.useCallback((partial) => {
    ...
    const tick = () => {
      ...
      if (isRewindingRef.current) {
        ...
        displayTime = new Date(
          now2.getTime() + offsetMinutesRef.current * 6e4 + 4e4
        );
  ...
  const handlePointerMove = reactExports.useCallback((e) => {
    ...
    e.stopPropagation();
    const dx = (e.clientX - dragStartPointerRef.current.x) / window.innerWidth * 100;
    const dy = (e.clientY - dragStartPointerRef.current.y) / window.innerHeight * 100;
  ...
  const handleFlashlightPointerDown = reactExports.useCallback((e) => {
    e.stopPropagation();
    const map = flashlightPointersRef.current;
    map.set(e.pointerId, { x: e.clientX, y: e.clientY });
    e.currentTarget.setPointerCapture(e.pointerId);
    if (map.size === 2 && settingsRef.current.pinchResizeEnabled) {
      const pts = Array.from(map.values());
      const dx = pts[0].x - pts[1].x;
      const dy = pts[0].y - pts[1].y;
      flashlightPinchStartDistRef.current = Math.sqrt(dx * dx + dy * dy);
      flashlightPinchStartSizeRef.current = settingsRef.current.flashlightIconSize;
    } else if (isEditModeRef.current) {
      dragTargetRef.current = "flashlight";
      dragStartPointerRef.current = { x: e.clientX, y: e.clientY };
      setPositions((prev) => {
        dragStartPosRef.current = { ...prev.flashlight };
        return prev;
      });
      setDragTarget("flashlight");
    }
  }, []);
  const handleFlashlightPointerMove = reactExports.useCallback((e) => {
    e.stopPropagation();
    const map = flashlightPointersRef.current;
    if (map.has(e.pointerId)) {
      map.set(e.pointerId, { x: e.clientX, y: e.clientY });
    }
    if (map.size === 2 && flashlightPinchStartDistRef.current !== null) {
      const pts = Array.from(map.values());
      const dx = pts[0].x - pts[1].x;
      const dy = pts[0].y - pts[1].y;
      const newDist = Math.sqrt(dx * dx + dy * dy);
      const scale = newDist / flashlightPinchStartDistRef.current;
      const newSize = Math.round(
        Math.max(
          40,
          Math.min(160, flashlightPinchStartSizeRef.current * scale)
        )
      );
      setSettings((prev) => ({ ...prev, flashlightIconSize: newSize }));
      setShowFlashlightSizeHint(true);
      if (flashlightHintTimerRef.current)
        clearTimeout(flashlightHintTimerRef.current);
      flashlightHintTimerRef.current = setTimeout(
        () => setShowFlashlightSizeHint(false),
        1e3
      );
    } else if (isEditModeRef.current && dragTargetRef.current === "flashlight") {
      const dx = (e.clientX - dragStartPointerRef.current.x) / window.innerWidth * 100;
      const dy = (e.clientY - dragStartPointerRef.current.y) / window.innerHeight * 100;
      const newX = Math.max(5, Math.min(95, dragStartPosRef.current.x + dx));
      const newY = Math.max(5, Math.min(95, dragStartPosRef.current.y + dy));
      ...
      pendingRafRef.current = requestAnimationFrame(() => {
        pendingRafRef.current = null;
        setPositions((prev) => ({ ...prev, flashlight: { x: newX, y: newY } }));
      });
    }
  }, []);
  const handleFlashlightPointerUp = reactExports.useCallback((e) => {
    e.stopPropagation();
    flashlightPointersRef.current.delete(e.pointerId);
    if (flashlightPointersRef.current.size < 2) {
      flashlightPinchStartDistRef.current = null;
    }
    if (dragTargetRef.current === "flashlight" && flashlightPointersRef.current.size === 0) {
      dragTargetRef.current = null;
      setDragTarget(null);
    }
  }, []);
  const handleCameraPointerDown = reactExports.useCallback((e) => {
    e.stopPropagation();
    const map = cameraPointersRef.current;
    map.set(e.pointerId, { x: e.clientX, y: e.clientY });
    e.currentTarget.setPointerCapture(e.pointerId);
    if (map.size === 2 && settingsRef.current.pinchResizeEnabled) {
      const pts = Array.from(map.values());
      const dx = pts[0].x - pts[1].x;
      const dy = pts[0].y - pts[1].y;
      cameraPinchStartDistRef.current = Math.sqrt(dx * dx + dy * dy);
      cameraPinchStartSizeRef.current = settingsRef.current.cameraIconSize;
    } else if (isEditModeRef.current) {
      dragTargetRef.current = "camera";
      dragStartPointerRef.current = { x: e.clientX, y: e.clientY };
      setPositions((prev) => {
        dragStartPosRef.current = { ...prev.camera };
        return prev;
      });
      setDragTarget("camera");
    }
  }, []);
  const handleCameraPointerMove = reactExports.useCallback((e) => {
    e.stopPropagation();
    const map = cameraPointersRef.current;
    if (map.has(e.pointerId)) {
      map.set(e.pointerId, { x: e.clientX, y: e.clientY });
    }
    if (map.size === 2 && cameraPinchStartDistRef.current !== null) {
      const pts = Array.from(map.values());
      const dx = pts[0].x - pts[1].x;
      const dy = pts[0].y - pts[1].y;
      const newDist = Math.sqrt(dx * dx + dy * dy);
      const scale = newDist / cameraPinchStartDistRef.current;
      const newSize = Math.round(
        Math.max(40, Math.min(160, cameraPinchStartSizeRef.current * scale))
      );
      setSettings((prev) => ({ ...prev, cameraIconSize: newSize }));
      setShowCameraSizeHint(true);
      if (cameraHintTimerRef.current) clearTimeout(cameraHintTimerRef.current);
      cameraHintTimerRef.current = setTimeout(
        () => setShowCameraSizeHint(false),
        1e3
      );
    } else if (isEditModeRef.current && dragTargetRef.current === "camera") {
      const dx = (e.clientX - dragStartPointerRef.current.x) / window.innerWidth * 100;
      const dy = (e.clientY - dragStartPointerRef.current.y) / window.innerHeight * 100;
      const newX = Math.max(5, Math.min(95, dragStartPosRef.current.x + dx));
      const newY = Math.max(5, Math.min(95, dragStartPosRef.current.y + dy));
      ...
      pendingRafRef.current = requestAnimationFrame(() => {
        pendingRafRef.current = null;
        setPositions((prev) => ({ ...prev, camera: { x: newX, y: newY } }));
      });
    }
  }, []);
  const handleCameraPointerUp = reactExports.useCallback((e) => {
    e.stopPropagation();
    cameraPointersRef.current.delete(e.pointerId);
    if (cameraPointersRef.current.size < 2) {
      cameraPinchStartDistRef.current = null;
    }
    if (dragTargetRef.current === "camera" && cameraPointersRef.current.size === 0) {
      dragTargetRef.current = null;
      setDragTarget(null);
    }
  }, []);
  ...
  const handleCameraTap = reactExports.useCallback(
    (e) => {
      e.stopPropagation();
      if (isEditModeRef.current) return;
      const now2 = Date.now();
      const diff = now2 - cameraTapTimeRef.current;
      if (diff < 400) {
        setShowSettings(true);
        cameraTapTimeRef.current = 0;
      } else {
        cameraTapTimeRef.current = now2;
      }
    },
    []
  );
  ...
  const clockStyle = {
    fontFamily,
    fontSize: isIOS ? `clamp(${Math.round(96 * settings.clockScale)}px, ${Math.round(25 * settings.clockScale)}vw, ${Math.round(180 * settings.clockScale)}px)` : `clamp(${Math.round(100 * settings.clockScale)}px, ${Math.round(26 * settings.clockScale)}vw, ${Math.round(190 * settings.clockScale)}px)`,
    fontWeight: isIOS ? 700 : 700,
    letterSpacing: isIOS ? "-0.04em" : "0",
    lineHeight: isIOS ? 0.9 : 1,
    color: "rgba(255,255,255,0.95)",
    textShadow: "0 2px 12px rgba(0,0,0,0.55), 0 1px 3px rgba(0,0,0,0.7), 0 0 40px rgba(255,255,255,0.08)",
    display: "flex",
    alignItems: "center",
    gap: "0.02em"
  };
  const dateStyle = {
    fontFamily: "-apple-system, 'SF Pro Text', system-ui, sans-serif",
    fontSize: isIOS ? "clamp(15px, 4.2vw, 19px)" : "clamp(15px, 4vw, 20px)",
    fontWeight: isIOS ? 600 : 500,
    color: isIOS ? "rgba(255,255,255,0.9)" : "rgba(255,255,255,0.85)",
    letterSpacing: "0.01em"
  };
  const colonStyle = {
    color: "#ffffff",
    marginBottom: isIOS ? "0.06em" : "0.1em",
    fontSize: isIOS ? "0.85em" : "0.9em",
    fontWeight: isIOS ? 700 : void 0,
    lineHeight: isIOS ? 1 : void 0
  };
  const btnStyle = {
    width: 72,
    height: 72,
    ...
    transition: dragTarget ? "none" : "box-shadow 0.2s ease, transform 0.2s ease",
    overflow: "hidden"
  };
  const getDragStyle = (key) => {
    const isActive = dragTarget === key;
    return {
      boxShadow: isActive ? "0 0 0 3px rgba(255,255,255,0.8), 0 0 30px rgba(255,255,255,0.4)" : isEditMode ? "0 0 0 1.5px rgba(255,255,255,0.35), 0 8px 32px rgba(0,0,0,0.4)" : "none",
      transform: isActive ? "translate(-50%, -50%) scale(1.08)" : "translate(-50%, -50%)"
    };
  };
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        settings.backgroundImage && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            style: {
              position: "fixed",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            onPointerMove: isEditMode ? handlePointerMove : void 0,
            onPointerUp: isEditMode ? handlePointerUp : void 0,
            onKeyDown: (e) => {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            onPointerDown: isEditMode ? handlePointerDown("clock") : void 0,
            onPointerMove: isEditMode ? handlePointerMove : void 0,
            onPointerUp: isEditMode ? handlePointerUp : void 0,
            style: {
              position: "absolute",
              ...
              flexDirection: "column",
              alignItems: "center",
              gap: isIOS ? "clamp(4px, 1vw, 8px)" : "clamp(6px, 1.5vw, 16px)",
              cursor: isEditMode ? dragTarget === "clock" ? "grabbing" : "grab" : "default",
              touchAction: "none",
              willChange: "transform",
              userSelect: "none",
              WebkitUserSelect: "none",
              ...getDragStyle("clock"),
              transform: dragTarget === "clock" ? "translate(-50%, -50%) scale(1.04)" : "translate(-50%, -50%)",
              transition: dragTarget === "clock" ? "none" : "box-shadow 0.2s ease"
            },
            children: isIOS ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { textAlign: "center" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: dateStyle, children: [
                displayDay,
                ", ",
                displayDate
              ] }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: clockStyle, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "digit-enter", children: displayHours }, `h-${displayHours}`),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: colonStyle, children: ":" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "digit-enter", children: displayMins }, `m-${displayMins}`)
              ] })
        ...
        settings.flashlightVisible && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
              ...
              onPointerDown: handleFlashlightPointerDown,
              onPointerMove: handleFlashlightPointerMove,
              onPointerUp: handleFlashlightPointerUp,
              onPointerCancel: handleFlashlightPointerUp,
              onClick: (e) => e.stopPropagation(),
              style: {
                ...btnStyle,
                width: settings.flashlightIconSize,
                height: settings.flashlightIconSize,
                position: "absolute",
                left: `${flashPos.x}%`,
                top: `${flashPos.y}%`,
                ...isEditMode ? getDragStyle("flashlight") : { transform: "translate(-50%,-50%)" },
                zIndex: 10,
                cursor: isEditMode ? dragTarget === "flashlight" ? "grabbing" : "grab" : "pointer",
                transition: dragTarget === "flashlight" ? "none" : "box-shadow 0.2s ease, transform 0.2s ease"
              },
              children: settings.flashlightCustomIcon ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                "img",
                {
                  src: settings.flashlightCustomIcon,
                  alt: "Flashlight",
                  style: {
                    width: settings.flashlightIconFit === "fill" ? "100%" : "70%",
                    height: settings.flashlightIconFit === "fill" ? "100%" : "70%",
                    objectFit: settings.flashlightIconFit,
                    display: "block",
                    borderRadius: settings.flashlightIconFit === "cover" ? "50%" : void 0
                  }
                }
              ) : /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "svg",
                {
                  ...
                  "aria-hidden": "true",
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("title", { children: "Flashlight" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "line",
                      {
                        x1: "12",
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M8.5 5 L15.5 5 L14.5 10 L9.5 10 Z" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "9.5", y: "10", width: "5", height: "8", rx: "0.5" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "rect",
                      {
                        x: "9.5",
          ...
          showFlashlightSizeHint && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              style: {
                position: "absolute",
                left: `${flashPos.x}%`,
                top: `calc(${flashPos.y}% - ${settings.flashlightIconSize / 2 + 14}px)`,
        ...
        settings.cameraVisible && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
              ...
              style: {
                ...btnStyle,
                width: settings.cameraIconSize,
                height: settings.cameraIconSize,
                position: "absolute",
                left: `${cameraPos.x}%`,
                top: `${cameraPos.y}%`,
                ...isEditMode ? getDragStyle("camera") : { transform: "translate(-50%,-50%)" },
                zIndex: 10,
                cursor: isEditMode ? dragTarget === "camera" ? "grabbing" : "grab" : "pointer",
                transition: dragTarget === "camera" ? "none" : "box-shadow 0.2s ease, transform 0.2s ease"
              },
              children: settings.cameraCustomIcon ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                "img",
                {
                  src: settings.cameraCustomIcon,
                  alt: "Camera",
                  style: {
                    width: settings.cameraIconFit === "fill" ? "100%" : "70%",
                    height: settings.cameraIconFit === "fill" ? "100%" : "70%",
                    objectFit: settings.cameraIconFit,
                    display: "block",
                    borderRadius: settings.cameraIconFit === "cover" ? "50%" : void 0
                  }
                }
              ) : /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "svg",
                {
                  ...
                  "aria-hidden": "true",
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("title", { children: "Camera" }),
          ...
          showCameraSizeHint && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              style: {
                position: "absolute",
                left: `${cameraPos.x}%`,
                top: `calc(${cameraPos.y}% - ${settings.cameraIconSize / 2 + 14}px)`,
                transform: "translate(-50%, -100%)",
                zIndex: 20,
                background: "rgba(0,0,0,0.6)",
                backdropFilter: "blur(8px)",
